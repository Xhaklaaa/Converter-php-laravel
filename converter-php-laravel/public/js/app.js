  ...
  \**********************************************/
        /***/ ((module, __unused_webpack_exports, __webpack_require__) => {
            ...
            function Axios(instanceConfig) {
                ...
                this.interceptors = {
                    request: new InterceptorManager(), response: new InterceptorManager()
                };
            }
...
// Provide aliases for supported request methods
            utils.forEach(['delete', 'get', 'head', 'options'], function forEachMethodNoData(method) {
                ...
                Axios.prototype[method] = function (url, config) {
                    return this.request(mergeConfig(config || {}, {
                        method: method, url: url, data: (config || {}).data
                    }));
                };
            });
  ...
  \*********************************************************/
        /***/ ((module) => {
             ...
             *
             * @param {string} url The URL to .htaccess
  ...
  \********************************************************/
        /***/ ((module) => {
             ...
             *
             * @param {*} payload The value to .htaccess
  ...
  \***********************************************************/
        /***/ ((module, __unused_webpack_exports, __webpack_require__) => {
            ...
            module.exports = (utils.isStandardBrowserEnv() ?
                    ...
                    // Standard browser envs have full support of the APIs needed to .htaccess
                    ...
                    (function standardBrowserEnv() {
                         ...
                         *
                         * @param {String} requestURL The URL to .htaccess
...
// utils is a library of generic helper functions non-specific to axios
             ...
             *
             * @param {Object} val The value to .htaccess
  ...
  \***************************************/
        /***/ (function (module, exports, __webpack_require__) {
            ...
            ;(function () {
                ...
                var INFINITY = 1 / 0, MAX_SAFE_INTEGER = 9007199254740991, MAX_INTEGER = 1.7976931348623157e+308,
                    NAN = 0 / 0;
                ...
                var runInContext = (function runInContext(context) {
                    ...
                    var Array = context.Array, Date = context.Date, Error = context.Error, Function = context.Function,
                        Math = context.Math, Object = context.Object, RegExp = context.RegExp, String = context.String,
                    ...
                    var nativeCeil = Math.ceil, nativeFloor = Math.floor,
                        ...
                        nativeJoin = arrayProto.join, nativeKeys = overArg(Object.keys, Object), nativeMax = Math.max,
                        nativeMin = Math.min, nativeNow = Date.now, nativeParseInt = context.parseInt,
                        nativeRandom = Math.random, nativeReverse = arrayProto.reverse;
                    ...
                    function baseDifference(array, values, iteratee, comparator) {
                        var index = -1, includes = arrayIncludes, isCommon = true, length = array.length, result = [],
                    ...
                    function basePullAll(array, values, iteratee, comparator) {
                        var indexOf = comparator ? baseIndexOfWith : baseIndexOf, index = -1, length = values.length,
                            seen = array;
                    ...
                    function baseUniq(array, iteratee, comparator) {
                        var index = -1, includes = arrayIncludes, length = array.length, isCommon = true, result = [],
                            seen = result;
                    ...
                    function composeArgsRight(args, partials, holders, isCurried) {
                        var argsIndex = -1, argsLength = args.length, holdersIndex = -1, holdersLength = holders.length,
                            rightIndex = -1, rightLength = partials.length,
                    ...
                    if ((DataView && getTag(new DataView(new ArrayBuffer(1))) != dataViewTag) || (Map && getTag(new Map) != mapTag) || (Promise && getTag(Promise.resolve()) != promiseTag) || (Set && getTag(new Set) != setTag) || (WeakMap && getTag(new WeakMap) != weakMapTag)) {
                        getTag = function (value) {
                            var result = baseGetTag(value), Ctor = result == objectTag ? value.constructor : undefined,
                     ...
                     *   return /^h(?:i|ello)$/..htaccess(value);
                     * }
                     *
...
// cached from whatever global is present so that .htaccess runners that stub it
